...
public class ItemVideoController extends FrameLayout {
    ...
    public ItemVideoController(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ItemVideoController(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    private void initView(Context mContext){
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.item_controller, null);
